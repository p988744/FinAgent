/**
 * FinAgent v2.0 - Main Application Entry
...
function Navigation() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 bg-noir-900/95 backdrop-blur-sm border-b border-noir-800">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-14">
          {/* Logo */}
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-brass-500/20 flex items-center justify-center">
            ...
            <span className="font-display font-semibold text-noir-100">FinAgent</span>
            <span className="text-xs text-noir-500 font-mono">v2.0</span>
          </div>
